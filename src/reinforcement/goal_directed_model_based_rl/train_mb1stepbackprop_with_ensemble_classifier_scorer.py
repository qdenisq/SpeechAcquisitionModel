...
from src.reinforcement.goal_directed_model_based_rl.algs.model_based_1_step_backprop_with_ensemble_classifier import ModelBased1StepBackPropWithEnsembleClassifier
...
def train(*args, **kwargs):
    ...
    alg = ModelBased1StepBackPropWithEnsembleClassifier(agent=agent, model_dynamics=md, **kwargs['mbbackprop'])
...
if __name__ == '__main__':
    with open('train_mb1stepbackprop_mfcc_config_with_ensemble_classifier.json') as data_file:
