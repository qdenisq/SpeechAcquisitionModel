...
from src.reinforcement.goal_directed_model_based_rl.algs.model_based_multi_step_backprop_with_ensemble_classifier_v2 import ModelBasedMultiStepBackPropWithEnsembleClassifierV2
...
def train(*args, **kwargs):
    ...
    alg = ModelBasedMultiStepBackPropWithEnsembleClassifierV2(agent=agent, model_dynamics=md, **kwargs['mbbackprop'])
...
if __name__ == '__main__':
    with open('train_multi_stepbackprop_mfcc_config_with_ensemble_classifierv2.json') as data_file:
