...
from src.reinforcement.goal_directed_model_based_rl.algs.model_based_backprop import ModelBasedBackProp
...
def train(*args, **kwargs):
    ...
    alg = ModelBasedBackProp(agent=agent, model_dynamics=md, **kwargs['mbbackprop'])
...
if __name__ == '__main__':
    with open('train_mbbackprop_config.json') as data_file:
